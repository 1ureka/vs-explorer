...
本擴展就是為了嘗試在 VS Code 內實現更流暢的本地互動。以下，將從使用者介面的四個主要區域來介紹這個系統瀏覽器的功能。
...
| 功能名稱 | 功能描述                                               |
| -------- | ------------------------------------------------------ |
| 佈局引擎 | 使用自定義虛擬化引擎與二分搜尋演算法，高效渲染大量圖片 |
...
| 檔案總管右鍵選單   | 在 VS Code 檔案總管、檔案標題列等地方，對資料夾或檔案右鍵選擇「在系統瀏覽器中顯示」 |
| 編輯器標題列按鈕   | 點擊編輯器右上角的按鈕，以檔案所在目錄開啟系統瀏覽器                                |
| 檔案總管標題列按鈕 | 點擊 VS Code 檔案總管區段標題列的按鈕，直接開啟系統瀏覽器                           |
